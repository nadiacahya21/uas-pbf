...
<div class="am-mainpanel">
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Data Dokter</h5>
            ...
            <div class="modal-content tx-size-sm">
                <form action="{{ route('dokter.store') }}" method="POST">
                    ...
                    <div class="modal-body pd-20">
                        <label class="form-control-label">Nama Dokter: <span class="tx-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Masukkan nama dokter" name="nama_dokter" required>
                    </div><!-- modal-body -->
        ...
        <div id="modalEdit{{ $item->id }}" class="modal fade">
            ...
            <div class="modal-content tx-size-sm">
                <form action="{{ route('dokter.update', $item->id) }}" method="POST">
                    ...
                    <div class="modal-body pd-20">
                        <label class="form-control-label">Nama Dokter: <span class="tx-danger">*</span></label>
                        <input type="text" class="form-control" value="{{ $item->nama_dokter }}" placeholder="Masukkan nama dokter" name="nama_dokter" required>
                    </div><!-- modal-body -->
                    <div class="modal-footer">
                    <button type="submit" class="btn btn-info pd-x-20">Simpan</button>
                    <button type="button" class="btn btn-secondary pd-x-20" data-dismiss="modal">batal</button>
